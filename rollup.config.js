...
<html lang="en">
  <head>
    ...
    <title>Kuwait Kannada Koota</title>
  ...
  <body class="text-blueGray-700 antialiased">
    <noscript>
      <strong
        >We're sorry but kkk doesn't work properly without
...
if (production) {
  fs.writeFileSync(
    ...
    indexTemplate
      ...
      .replace(/<<live-preview-link>>/g, "/kkk")
  );
  fs.writeFileSync(
    "./ui/200.html",
    indexTemplate
...
export default {
  ...
  plugins: [
    ...
    // Watch the `ui` directory and refresh the
    // browser on changes when not in production
    !production && livereload("ui"),
